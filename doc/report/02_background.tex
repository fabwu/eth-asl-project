...
\notepascal{Hat Hutchinson wirklich den banachschen fixpunksatz bewiesen?}
...
mathematical functions are used. The cost metric is define as
\begin{align}
...
using the precomputed sums. We therefore get the following cost for
$\alpha_{i}$:
