...
set nox2tics
set noy2tics
set title "Graph 1 (Results/skylake-scalar/Run.001/FLOPS.016)"
...
set output "Results/skylake-scalar/Run.001/FLOPS.016/graph1.ps"
plot "Results/skylake-scalar/Run.001/FLOPS.016/pre" using 2:4
#EOF
