...
set nox2tics
set noy2tics
set title "Graph 4 (Results/skylake-scalar/Run.001/FLOPS.016)"
...
set output "Results/skylake-scalar/Run.001/FLOPS.016/graph4.ps"
plot "Results/skylake-scalar/Run.001/FLOPS.016/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
