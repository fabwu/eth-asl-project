...
set nox2tics
set noy2tics
set title "Graph 4 (Results/skylake-simd/Run.001/FLOPS.001)"
...
set output "Results/skylake-simd/Run.001/FLOPS.001/graph4.ps"
plot "Results/skylake-simd/Run.001/FLOPS.001/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
