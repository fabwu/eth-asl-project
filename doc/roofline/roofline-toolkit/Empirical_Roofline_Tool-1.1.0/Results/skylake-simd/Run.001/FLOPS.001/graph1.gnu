...
set nox2tics
set noy2tics
set title "Graph 1 (Results/skylake-simd/Run.001/FLOPS.001)"
...
set output "Results/skylake-simd/Run.001/FLOPS.001/graph1.ps"
plot "Results/skylake-simd/Run.001/FLOPS.001/pre" using 2:4
#EOF
